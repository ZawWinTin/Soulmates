...
public class LevelStars : MonoBehaviour
{
    ...
    public Image background; // the rating band behind the stars

    public Color earnedColor = Color.white; // star_3d is gold — white shows it natural
    public Color emptyColor = new Color(0.9f, 0.86f, 0.72f, 0.55f);

    void OnEnable() => Refresh();

    public void Refresh()
    {
        // Hide the whole band while the level is locked (the lock icon shows there instead).
